...
class CraniAddPhotoData extends StatefulWidget {
  CraniAddPhotoData({required this.prefix, required this.numbers,
    required this.images, required this.isDMG,required this.date});
  ...
  @override
  State<CraniAddPhotoData> createState() => _CraniAddPhotoDataState();
}


class _CraniAddPhotoDataState extends State<CraniAddPhotoData> {
  ...
  Future<String?> _uploadImageToFirebaseStorage(XFile images, String imageName,
    ...
    try {
      ...
      final Reference storageRef = FirebaseStorage.instance
          .ref()
          .child('/DKM/OUT/$folderPath/$folderName/$imageName');
                  ...
                  onPressed: () async {
                    ...
                    Future.delayed(Duration.zero,() async{
                      ...
                      final data = Data(
                          ...
                          isDMG: widget.isDMG);
                      CraniDataServices().updateData(data,widget.date);
                    });

                    Navigator.pushReplacementNamed(
                        context, CraniView.routeName
                    );
                  },
                ),
              ),
