...
class CraniCameraScreen extends StatefulWidget {
  CraniCameraScreen({required this.prefix, required this.numbers,
  ...
  @override
  _CraniCameraScreenState createState() => _CraniCameraScreenState();
}

class _CraniCameraScreenState extends State<CraniCameraScreen> {
                  ...
                  onPressed: () async {
                    ...
                    Future.delayed(Duration.zero,() async{
                      ...
                      final data = Data(
                          ...
                          isDMG: widget.isDMG);
                      CraniDataServices().addData(data,formattedDateNow);
                    });
